...
ORDER BY (sum(pool.amount)) DESC;
    ...
    )
    {
        return gatewayPoolIdentifier switch
        {
            ...
            GatewayPoolIdentifier.Xdefi => new []
            {
                TerraPylonPoolFriendlyName.Xdefi1,
            ...
            GatewayPoolIdentifier.GalacticPunks => new []
            {
            ...
            GatewayPoolIdentifier.TerraBots => new []
            {
                TerraPylonPoolFriendlyName.TerraBots
            },
